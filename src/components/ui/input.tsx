        ...
        <div className="relative">
          <div
            className={cn(
              ...
              {
                "border-none text-[#F1EDE4] bg-divider-100 cursor-not-allowed": disabled,
          ...
          >
            {icon && <div className="absolute left-4 top-1/2 -translate-y-1/2 flex items-center">{icon}</div>}
            <input
              type={type}
              id={id}
            ...
            />
            {clearable && hasValue && (
              <button type="button" onClick={clearField} className="absolute right-4">
